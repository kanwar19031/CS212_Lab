...
# implementing the Selective Repeat Protocol
...
class rdt_Sender(object):
	...
	def print_status(self):
		print("TIME:",self.env.now,"Current window is :", [(self.base+i)%self.K for i in range(0,self.N)],"base =",self.base,"nextseqnum =",self.nextseqnum)
		print("==================")
