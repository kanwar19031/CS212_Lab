...
# 	# create the DATA and ACK channels and set channel parameters
# channel_for_data = UnreliableChannel(
# 	env=env, name="DATA_CHANNEL", Pc=0.2, Pl=0, propagation_delay=2, transmission_rate=1000)
# channel_for_ack = UnreliableChannel(
# 	env=env, name="ACK_CHANNEL", Pc=0.2, Pl=0, propagation_delay=2, transmission_rate=1000)
...
rdt_receiver  = rdt_Receiver(env=env)
# create the DATA and ACK channels and set channel parameters
channel_for_data  = UnreliableChannel(env=env,name="DATA_CHANNEL",Pc=0.2,Pl=0,propagation_delay=2, transmission_rate=1000)
channel_for_ack	  = UnreliableChannel(env=env,name="ACK_CHANNEL", Pc=0.2,Pl=0,propagation_delay=2, transmission_rate=1000)
